...
public class ExpSimpleBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements ExpSimpleVisitor<T> {
	 ...
	 */
	@Override public T visitStart(@NotNull ExpSimpleParser.StartContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitExp(@NotNull ExpSimpleParser.ExpContext ctx) { return visitChildren(ctx); }
}